...
import { signInWithEmailAndPassword, onAuthStateChanged } from '@/services/firebase'; // modular Firebase
            ...
            <Animated.View style={[styles.content, { opacity: fadeAnim, transform: [{ translateY: slideAnim }, { scale: scaleAnim }] }]}>
              <View style={styles.header}>
                ...
                <View style={styles.welcomeContainer}>
                  <Text style={styles.subtitle}>Log in to continue helping</Text>
                </View>
              </View>
              ...
              <BlurView intensity={20} tint="light" style={styles.formCard}>
                <View style={styles.formCardInner}>
                  ...
                  <TouchableOpacity
                    style={[styles.loginButtonWrapper, styles.loginButton, isLoading && styles.buttonDisabled, (!email || !password) && styles.buttonInactive]}
                    onPress={handleLogin}
              ...
              <View style={styles.footer}>
                <Text style={styles.footerText}>New to CommUnity? </Text>
                <TouchableOpacity onPress={() => navigation.navigate('Auth', { screen: 'Signup' })} disabled={isLoading} activeOpacity={0.7} style={styles.signupLinkButton}>
                  <Text style={styles.signupLink}>Join Our Community</Text>
                </TouchableOpacity>
              </View>
            </Animated.View>
          </SafeAreaView>
...
const styles = StyleSheet.create({
  ...
  forgotPasswordText: { color: colors.primary, fontSize: 13, fontFamily: 'Inter_600SemiBold' },
  loginButtonWrapper: { marginTop: 8, marginBottom: 24, borderRadius: 16, overflow: 'hidden', shadowColor: colors.primary, shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.3, shadowRadius: 16, elevation: 8 },
  loginButton: { 
    padding: 20, 
    alignItems: 'center', 
  ...
  signupLinkButton: { paddingHorizontal: 16, paddingVertical: 8, borderRadius: 20, backgroundColor: colors.primary },
  signupLinkGradient: { paddingHorizontal: 16, paddingVertical: 8, borderRadius: 20 },
  signupLink: { color: '#FFFFFF', fontSize: 15, fontFamily: 'Inter_700Bold', letterSpacing: 0.3 },
});
